...
class Sales extends MX_Controller
{
    ...
    function __construct()
    {
        ...
        $access_arr = array(
            ...
            'sales/accessories_sale_edit' => 'no_restriction',
            'sales/quotation_view' => 'no_restriction',
            ...
            'sales/update_used_invoice' => 'no_restriction',
            'sales/update_accessories_invoice' => 'no_restriction',
            'sales/update_fresh_invoice' => 'no_restriction',
            ...
            'sales/fresh_mobile_sale' => 'no_restriction',
            'sales/used_mobile_sale' => 'no_restriction',
            'sales/accessories_sale' => 'no_restriction',
    ...
    public function fresh_mobile_sale_edit($id)
    {
        ...
        $datas["category"] = $details = $this->categories_model->get_all_category('Fresh Mobiles');

        $this->template->write_view('content', 'sales/fresh_mobile_sale_edit', $datas);

        $this->template->render();
    }

    public function used_mobile_sale_edit($id)
    {
        ...
        $this->template->write_view('content', 'sales/used_mobile_sale_edit', $datas);

        $this->template->render();
    }

    public function accessories_sale_edit($id)
    {
        ...
        $this->template->write_view('content', 'sales/accessories_sale_edit', $datas);
    ...
    {
        $input = $this->input->get();
        $del = $this->project_cost_model->delete_inv_by_id($id);
        echo 1;
        exit;
    }
    ...
    public function fresh_mobile_sale()
    {
        ...
        $data["category"] = $details = $this->categories_model->get_all_category('Fresh Mobiles');
        ...
        $this->template->write_view('content', 'sales/fresh_mobile_invoice', $data);

        $this->template->render();
    }


    public function used_mobile_sale()
    {
        ...
        $data["category"] = $details = $this->categories_model->get_all_category('Used Mobiles');
        ...
        $this->template->write_view('content', 'sales/used_mobile_invoice', $data);

        $this->template->render();
    }


    public function accessories_sale()
    {
        ...
        $data["category"] = $details = $this->categories_model->get_all_category('Accessories');
        ...
        $this->template->write_view('content', 'sales/accessories_mobile_invoice', $data);
    ...
    public function update_invoice()
    {
        ...
        if ($this->input->post()) {
            ...
            $update_data = [
                "bill_amount" => $input['quotation']['net_total'],
                "created_date" => ($input['quotation']['created_date']) ? date('Y-m-d', strtotime($input['quotation']['created_date'])) : '',
            ];
    ...
    public function update_fresh_invoice()
    {
    ...
    public function update_used_invoice()
    {
    ...
    public function update_accessories_invoice()
    {
