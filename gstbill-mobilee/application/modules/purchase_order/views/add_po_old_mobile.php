                ...
                <td>
                    ...
                    <select id='cat_id' tabindex="-1" readonly class='form-align cat_id static_style class_req form-control' style="width:100%" name='categoty[]'>
                        ...
                        ?>
                                ...
                                <option value='<?php echo $val['cat_id'] ?>' <?php echo ($val['categoryName'] == 'Used Mobiles') ? 'selected' : '';?>><?php echo $val['categoryName'] ?></option>
                    ...
                    <tbody id='app_table'>
                        ...
                        <tr class="inc_class0" data-inc="0">
                            ...
                            <td>
                                ...
                                <select id='cat_id' tabindex="10" readonly class='form-control cat_id static_style class_req required' name='categoty[]' style="width:100%">
                            ...
                            <td class="ime_modal">
                                ...
                                <div class="col-md-5">
                                    <input type="text" tabindex="13" name='quantity[]' style="width:50px;" class="qty  form-control" value="0" />
                                </div>
                                <div class="col-md-2">
                            ...
                            <td style="text-align: center;">
                                ...
                                <input type="text" tabindex="14" name='per_cost[]' style="width:70px;" class="cost_price percost required" />
                                <input type="hidden" name="price_with_gst[]" class="price_with_gst">
                                <input type="hidden" name="price_without_gst[]" class="price_without_gst">
                        ...
                        <input type="text"  tabindex="-1"   style="width:70px;" class="gross" />
                            ...
                            <td class="action-btn-align">
                                ...
                                <input type="text" tabindex="16" style="width:75px;" class="hsn_code" readonly="readonly" autocomplete="off" />
                            ...
                            <td class="action-btn-align cgst_td">
                                ...
                                <input type="text" tabindex="17" name='tax[]' style="width:70px;" class="pertax" readonly="readonly" />

                            </td>

                            <td class="action-btn-align sgst_td">

                                <input type="text" tabindex="18" name='gst[]' style="width:70px;" class="gst" readonly="readonly" />

                            </td>

                            <td class="action-btn-align igst_td">

                                <input type="text" tabindex="19" name='igst[]' style="width:70px;" class="igst wid50" readonly="readonly" />
                        ...
                        <input type="text"   tabindex="-1"   name='transport[]' style="width:70px;" class="transport" />
                            ...
                            <td>
                                ...
                                <input type="text" tabindex="20" style="width:70px;" name='sub_total[]' readonly="readonly" class="subtotal text_right" />
                ...
                success: function(data) {
                    ...
                    if (result != null && result.length > 0) {
                        ...
                        $.each(result, function(key, value) {
                            ...
                            var selected = (value.categoryName == "Used Mobiles") ? 'selected' : '';
