    ...
    <div class="contentpanel mb-45">
        ...
        <table class="static" style="display: none;">
            ...
            <tr>
                ...
                <td class="action-btn-align">
                    ...
                    <a id='delete_group' class="btn-sm btn-danger"><span class="glyphicon glyphicon-trash"></span></a>
        ...
        <form method="post" class="panel-body" id="inward_post_form">
                    ...
                    <tbody id='app_table'>
                        ...
                        <input type="text"   tabindex="-1"   name='transport[]' style="width:70px;" class="transport" />
                            ...
                            <td class="action-btn-align">
                                ...
                                <a id='delete_group' tabindex="-1" class="btn-sm btn-danger"><span class="glyphicon glyphicon-trash"></span></a>
            ...
            <div class="action-btn-align mb-bot20">
                ...
                <button class="btn btn-primary" name="print" tabindex="" value="yes" id="save"><span class="glyphicon glyphicon-plus"></span> Save and <span class="glyphicon glyphicon-print"></span> print</button>
...
<script type="text/javascript">
    ...
    $('.percost,.pertax,.totaltax,.gst,.igst,.discount,.transport').on('keyup', function() {
