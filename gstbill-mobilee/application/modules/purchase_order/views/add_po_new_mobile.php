                    ...
                    <select id='cat_id' tabindex="-1" readonly class='form-align cat_id static_style class_req form-control' style="width:100%" name='categoty[]'>
                        ...
                        if (isset($category) && !empty($category)) {
                         ...
                         ?>
                                ...
                                <option value='<?php echo $val['cat_id'] ?>' <?php echo ($val['categoryName'] == 'Fresh Mobiles') ? 'selected' : '';?>><?php echo $val['categoryName'] ?></option>
                    ...
                    <tbody id='app_table'>
                        ...
                        <tr class="inc_class0" data-inc="0">
                            ...
                            <td>
                                ...
                                <input type="text" tabindex="11" name="model_no[]" id="model_no" style="width:100%" class='form-control form-align auto_customer tabwid model_no required' readonly="" />
                            ...
                            <td>
                                ...
                                <select id='brand_id' name='brand[]' tabindex="12" class="form-control brand_id">
                            ...
                            <td class="ime_modal">
                                ...
                                <div class="col-md-5">
                                    <input type="text" tabindex="12" name='quantity[]' style="width:50px;" class="qty  form-control" value="0" />
                                </div>
                                <div class="col-md-2">
                            ...
                            <td style="text-align: center;">
                                ...
                                <input type="text" tabindex="13" name='per_cost[]' style="width:70px;" class="cost_price percost required" />
                        ...
                        <input type="text"  tabindex="-1"   style="width:70px;" class="gross" />
                            ...
                            <td class="action-btn-align">
                                ...
                                <input type="text" tabindex="15" style="width:75px;" class="hsn_code" readonly="readonly" autocomplete="off" />
                            ...
                            <td class="action-btn-align cgst_td">
                                ...
                                <input type="text" tabindex="16" name='tax[]' style="width:70px;" class="pertax" readonly="readonly" />

                            </td>

                            <td class="action-btn-align sgst_td">

                                <input type="text" tabindex="17" name='gst[]' style="width:70px;" class="gst" readonly="readonly" />

                            </td>

                            <td class="action-btn-align igst_td">

                                <input type="text" tabindex="18" name='igst[]' style="width:70px;" class="igst wid50" readonly="readonly" />
                    ...
                    <tfoot>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="col-md-5"><input type="text" tabindex="21" name="po[total_qty]" readonly="readonly" class="total_qty" style="width:50px;" id="total" /></div>
                            </td>

                            <td colspan="4" style="text-align:right;"><b>Sub Total</b></td>

                            <td><input type="text" tabindex="22" name="po[subtotal_qty]" readonly="readonly" class="final_sub_total text_right" style="width:70px;" /></td>
                        ...
                        <tr>
                            ...
                            <td colspan="3" style="text-align:right;font-weight:bold;">
                                <input type="text" tabindex="23" name="po[tax_label]" class='tax_label text_right' style="width:100%;" />
                            </td>

                            <td>

                                <input type="text" tabindex="24" name="po[tax]" class='totaltax text_right' style="width:70px;" />
                        ...
                        <tr>
                            ...
                            <td colspan="3" style="text-align:right;font-weight:bold;">
                                Taxable Price</td>
                            <td><input type="text" tabindex="25" name="po[taxable_price]" readonly="readonly" class="taxable_price text_right" style="width:70px;" /></td>

                            <td colspan="1" style="text-align:right;font-weight:bold;">CGST</td>
                            <td><input type="text" tabindex="26" name="po[cgst_price]" readonly="readonly" class="cgst_price text_right" style="width:70px;" /></td>

                            <td colspan="1" style="text-align:right;font-weight:bold;" class="igst_sgst">SGST</td>
                            <td><input type="text" tabindex="27" name="po[sgst_price]" readonly="readonly" class="sgst_price text_right" style="width:70px;" /></td>
                ...
                success: function(data) {
                    ...
                    if (result != null && result.length > 0) {
                        ...
                        $.each(result, function(key, value) {
                            ...
                            var selected = (value.categoryName == "Fresh Mobiles") ? 'selected' : '';
