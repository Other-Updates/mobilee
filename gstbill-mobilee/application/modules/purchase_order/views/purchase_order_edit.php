                        ...
                        <table class="table  table-bordered responsive dataTable no-footer dtr-inline" id="add_quotation">
                                ...
                                ?>
                                        <tr class="" data-inc="">
                                            ...
                                            <td class="ime_modal">
                                                ...
                                                <div class="col-md-5">
                                                    <input type="text" tabindex="" name='quantity[]' style="width:50px;" class="qty  form-control" value="<?php echo $vals['quantity']; ?>" />
                                                </div>
                            ...
                            <tfoot>
                                ...
                                <tr>
                                    ...
                                    <td colspan="3" style="text-align:right;font-weight:bold;"><input type="text" name="po[tax_label]" class='tax_label text_right' style="width:100%;" value="<?php echo $val['tax_label']; ?>" /></td>
                                    <td>
