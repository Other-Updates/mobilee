    ...
    <div class="contentpanel mb-45">
        ...
        <table class="static" style="display: none;">
            ...
            <tr>
                ...
                <td>
                    ...
                    <select id='cat_id' tabindex="-1" readonly class='form-align cat_id static_style class_req form-control' style="width:100%" name='categoty[]'>
                        ...
                        ?>
                                ...
                                <option value='<?php echo $val['cat_id'] ?>' <?php echo ($val['categoryName'] == 'Accessories') ? 'selected' : '';?>><?php echo $val['categoryName'] ?></option>
                ...
                <td class="ime_modal">
                    ...
                    <div class="col-md-5">
                        ...
                        <input type="text" tabindex="" name='quantity[]' style="width:50px;" class="qty  form-control" value="0" />
        ...
        <form method="post" class="panel-body" id="inward_post_form">
                ...
                <div class="col-md-4">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            ...
                            <input type="text" tabindex="2" name="po[pr_no]" class="code form-control colournamedup  form-align" value="" id="pr_id">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" tabindex="3" name="supplier[store_name]" id="customer_name" class=' form-align auto_customer required ' />
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            ...
                            <div class="input-group">
                                ...
                                <input tabindex="4" type="text" name="supplier[mobil_number]" id="customer_no" class="form-align" />
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8" id='customer_td'>
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" tabindex="5" name="supplier[email_id]" id="email_id" class=" form-align" />
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="supplier[tin_no]" tabindex="6" id="tin" class="form-align" />
                ...
                <div class="col-md-4">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            ...
                            <textarea name="supplier[address1]" tabindex="7" id="address1" class="form-control form-align"></textarea>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" tabindex="8" class="form-align datepicker required" name="po[created_date]" placeholder="dd-mm-yyyy" value="<?php echo date('d-m-Y'); ?>" id="form_date" onblur="validate_date('form_date')" )>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            ...
                            <input type="radio" tabindex="9" class="receiver" value="cash" name="po[po_type]" checked /> Cash Purchase &nbsp;

                            <input type="radio" tabindex="9" class="receiver" value="credit" name="po[po_type]" /> Credit Purchase<br>
                    ...
                    <tbody id='app_table'>
                        ...
                        <tr class="inc_class0" data-inc="0">
                            ...
                            <td>
                                ...
                                <select id='cat_id' tabindex="-1" readonly class='form-control cat_id static_style class_req required' name='categoty[]' style="width:100%">
                            ...
                            <td>
                                ...
                                <input type="text" tabindex="10" name="model_no[]" id="model_no" style="width:100%" class='form-control form-align auto_customer tabwid model_no required' readonly="" />
                            ...
                            <td class="ime_modal">
                                <div class="col-md-5">
                                    <input type="text" tabindex="" name='available_quantity[]' style="width:50px;" class="form-control  stock_qty" value="0" readonly="readonly" />
                                </div>

                                <div class="col-md-5">
                                    <input type="text" tabindex="11" name='quantity[]' style="width:50px;" class="qty  form-control" value="0" />
                                </div>
                                <div class="col-md-2">
                            ...
                            <td style="text-align: center;">
                                ...
                                <input type="text" tabindex="12" name='per_cost[]' style="width:70px;" class="cost_price percost required" />
                                <input type="hidden" name="price_with_gst[]" class="price_with_gst">
                                <input type="hidden" name="price_without_gst[]" class="price_without_gst">
								...
								<td style="text-align: center;">
							<input type="text" tabindex="13" name='sale_cost[]' style="width:70px;" class="sales_price salecost"/>
							</td>
                            <!--  <td class="action-btn-align">
                        ...
                        <input type="text"  tabindex="-1"   style="width:70px;" class="gross" />
                            ...
                            <td class="action-btn-align cgst_td">
                                ...
                                <input type="text" tabindex="15" name='tax[]' style="width:70px;" class="pertax" readonly="readonly" />

                            </td>

                            <td class="action-btn-align sgst_td">

                                <input type="text" tabindex="16" name='gst[]' style="width:70px;" class="gst" readonly="readonly" />

                            </td>

                            <td class="action-btn-align igst_td">

                                <input type="text" tabindex="17" name='igst[]' style="width:70px;" class="igst wid50" readonly="readonly" />

                            </td>
                            <input type="hidden" tabindex="18" name='transport[]' style="width:70px;" class="transport" value="" />
                            <!-- <td>
                        ...
                        <input type="text"   tabindex="-1"   name='transport[]' style="width:70px;" class="transport" />
                            ...
                            <td>
                                ...
                                <input type="text" tabindex="19" style="width:70px;" name='sub_total[]' readonly="readonly" class="subtotal text_right" />
                    ...
                    <tfoot>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="col-md-5"><input type="text" tabindex="20" name="po[total_qty]" readonly="readonly" class="total_qty" style="width:50px;" id="total" /></div>
                            </td>

                            <td colspan="4" style="text-align:right;"><b>Sub Total</b></td>

                            <td><input type="text" tabindex="21" name="po[subtotal_qty]" readonly="readonly" class="final_sub_total text_right" style="width:70px;" /></td>
                        ...
                        <tr>
                            ...
                            <td colspan="3" style="text-align:right;font-weight:bold;">
                                <input type="text" tabindex="22" name="po[tax_label]" class='tax_label text_right' style="width:100%;" />
                            </td>

                            <td>

                                <input type="text" tabindex="23" name="po[tax]" class='totaltax text_right' style="width:70px;" />
                        ...
                        <tr>
                            ...
                            <td colspan="3" style="text-align:right;font-weight:bold;">
                                Taxable Price</td>
                            <td><input type="text" tabindex="24" name="po[taxable_price]" readonly="readonly" class="taxable_price text_right" style="width:70px;" /></td>

                            <td colspan="1" style="text-align:right;font-weight:bold;">CGST</td>
                            <td><input type="text" tabindex="25" name="po[cgst_price]" readonly="readonly" class="cgst_price text_right" style="width:70px;" /></td>

                            <td colspan="1" style="text-align:right;font-weight:bold;" class="igst_sgst">SGST</td>
                            <td><input type="text" tabindex="26" name="po[sgst_price]" readonly="readonly" class="sgst_price text_right" style="width:70px;" /></td>



                            <td colspan="1" style="text-align:right;font-weight:bold;">Net Total</td>

                            <td><input type="text" tabindex="27" name="po[net_total]" readonly="readonly" class="final_amt text_right" style="width:70px;" /></td>
                        ...
                        <tr>
                            ...
                            <td colspan="15">
                                ...
                                <input name="po[remarks]" tabindex="28" type="text" class="form-control remark" />
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            ...
                            <div>
                                ...
                                <input type="text" tabindex="29" class="form-control datepicker class_req borderra0 terms" name="po[delivery_schedule]" id="delivery_schedule" placeholder="dd-mm-yyyy" value="<?php echo date('d-m-Y'); ?>" onblur="validate_date('delivery_schedule')">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            ...
                            <div>
                                ...
                                <input type="text" tabindex="30" class="form-control class_req borderra0 terms" name="po[mode_of_payment]" />
            ...
            <div class="action-btn-align mb-bot20">
                ...
                <button class="btn btn-primary" name="print" tabindex="-1" value="no" id="save"><span class="glyphicon glyphicon-plus"></span> Create </button>

                <button class="btn btn-primary" name="print" tabindex="" value="yes" id="save_print"><span class="glyphicon glyphicon-plus"></span> Save and <span class="glyphicon glyphicon-print"></span> print</button>
...
<script type="text/javascript">
    ...
    $('#save,#save_print').on('click', function() {
    ...
    $('.percost,.salecost,.pertax,.totaltax,.gst,.igst,.discount,.transport').on('keyup', function() {
                ...
                success: function(data) {
                    ...
                    if (result != null && result.length > 0) {
                        ...
                        $.each(result, function(key, value) {
                            ...
                            var selected = (value.categoryName == "Accessories") ? 'selected' : '';

                            option_text += '<option value="' + value.cat_id + '" ' +selected+ '>' + value.categoryName + '</option>';

                        });

                        $('.cat_id').html(option_text);

                        $('.model_no,.model_no_extra').val('');
