  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
  	<div class="header-left">
        <a href="<?php echo $this->config->item('base_url') . 'admin/dashboard' ?>" class="logo">
            <img src="<?= $theme_path; ?>/images/logo-login2.png" alt="" width="130" >
        </a>
    </div>
                            ...
                            <?php if ($this->user_auth->is_module_allowed('stock')): ?>
                                    ...
                                    <ul class="nav nav-treeview">
                                        <li class="<?= ($cur_class == 'stock' && $cur_method =='index') ? 'active' : '' ?>" >
                                            <a href="<?php echo $this->config->item('base_url') . 'stock/' ?>"><i class="far fa-circle nav-icon"></i> Stock</a>
                                        </li>
                                    </ul>
                                </li>
                            <?php endif; ?>
                                ...
                                <li class="nav-item has-treeview masters_tab9 reports_tab <?php echo (($cur_class == 'report' ) && $cur_method == 'purchase_report'  || $cur_method == 'customer_based_report' || $cur_method == 'stock_report' || $cur_method == 'stock_list_report' || $cur_method == 'invoice_report' ||  $cur_method == 'profit_list') ? ' menu-open' : '' ?>"><a class="nav-link" href="javascript: void(0)" ><i class="fa fa-fw fa-bar-chart-o"></i> Reports <i class="right fas fa-angle-left"></i></a>
									...
									<?php if ($this->user_auth->is_section_allowed('reports', 'gst_report')): ?>
                                            <li class="<?= ($cur_method == 'gst_report') ? 'active' : '' ?>">
                                                <a href="<?php echo $this->config->item('base_url') . 'report/gst_report' ?>"><i class="far fa-circle nav-icon"></i> GST Report</a>
                                            </li>
                                        <?php endif; ?>
                                        <?php if ($this->user_auth->is_section_allowed('reports', 'customer_based_report')): ?>
                                            <li class="<?= ($cur_method == 'customer_based_report') ? 'active' : '' ?>"><a href="<?php echo $this->config->item('base_url') . 'report/customer_based_report' ?>"><i class="far fa-circle nav-icon"></i> Customer Based Report</a>
                                            </li>
                                        <?php endif; ?>

                                        <?php if ($this->user_auth->is_section_allowed('reports', 'stock_report')): ?>
                                            <li class="<?= ($cur_method == 'stock_report') ? 'active' : '' ?>"><a href="<?php echo $this->config->item('base_url') . 'report/stock_report' ?>"><i class="far fa-circle nav-icon"></i> Stock Report</a>
                                            </li>
                                        <?php endif; ?>
                                        <?php if ($this->user_auth->is_section_allowed('reports', 'stock_list_report')): ?>
                                            <li class="<?= ($cur_method == 'stock_list_report') ? 'active' : '' ?>"><a href="<?php echo $this->config->item('base_url') . 'stock/stock_list_report' ?>"><i class="far fa-circle nav-icon"></i> Stock Based Report</a>
                                            </li>
                                        <?php endif; ?>
                                        <?php if ($this->user_auth->is_section_allowed('reports', 'purchase_report')): ?>
                                            <li class="<?= ($cur_method == 'purchase_report') ? 'active' : '' ?>"><a href="<?php echo $this->config->item('base_url') . 'report/purchase_report' ?>"><i class="far fa-circle nav-icon"></i> Purchase Report</a>
                                            </li>
                                        <?php endif; ?>
                                        <?php if ($this->user_auth->is_section_allowed('reports', 'invoice_report')): ?>
                                            <li class="<?= ($cur_method == 'invoice_report') ? 'active' : '' ?>"><a href="<?php echo $this->config->item('base_url') . 'report/invoice_report' ?>"><i class="far fa-circle nav-icon"></i> Sales Invoice Report</a>
                                            </li>
                                        <?php endif; ?>
                                        <?php if ($this->user_auth->is_section_allowed('reports', 'profit_list')): ?>
                                            <li class="<?= ($cur_method == 'profit_list') ? 'active' : '' ?>">
                                                <a href="<?php echo $this->config->item('base_url') . 'report/profit_list' ?>"><i class="far fa-circle nav-icon"></i> Profit and Loss Report</a>
                                            </li>
                                        <?php endif; ?>
        ...
        <footer class="main-footer">
            <div class="container">
                <div class="copyright" id="bot_copyright">
                    <div class="nvqc-show-hide-log  mt-foot">Copyright <?php echo date('Y'); ?> &COPY; Mobilee. <span class="pull-right">Powered By <a href="http://f2fsolutions.co.in/" target="_blank" style="color:#000;">F2F Solutions</a></span></div>
                </div>
            </div>
